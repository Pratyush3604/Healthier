...
const features = [
  ...
  { icon: Dumbbell, title: 'Exercise Library', description: '106 exercises with instructions, muscle groups & tips', link: '/exercise-library', gradient: 'from-orange-500 to-red-500' },
  ...
  { icon: Calculator, title: 'BMI Calculator', description: 'BMI, calories, water intake & ideal weight', link: '/bmi-calculator', gradient: 'from-sky-500 to-blue-500' },
  { icon: Droplets, title: 'Water Tracker', description: 'Track daily water intake with progress & streaks', link: '/water-tracker', gradient: 'from-blue-400 to-cyan-400' },
  ...
  { icon: FileText, title: 'Health Reports', description: 'All your health data aggregated in one place', link: '/health-reports', gradient: 'from-emerald-500 to-cyan-500' },
  { icon: Lightbulb, title: 'Health Tips', description: '170+ wellness tips for a healthier lifestyle', link: '/health-tips', gradient: 'from-yellow-500 to-orange-500' },
