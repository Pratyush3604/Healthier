...
const healthMetrics = [
  { icon: Heart, label: 'Heart Rate', value: '--', unit: 'bpm', color: 'text-destructive', note: 'Enter in Vitals' },
  { icon: Droplets, label: 'Water Today', value: '0', unit: 'ml', color: 'text-primary', note: 'Track intake' },
  { icon: Moon, label: 'Sleep Score', value: '--', unit: '/100', color: 'text-accent', note: 'Run analysis' },
  { icon: TrendingUp, label: 'BMI', value: '--', unit: '', color: 'text-success', note: 'Calculate BMI' },
];
    ...
    <div className="container mx-auto px-4 py-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <motion.div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-8 gap-3" variants={container} initial="hidden" animate="visible">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link to="/emergency" className="bg-gradient-to-br from-red-500/10 to-rose-500/10 border border-red-500/20 rounded-2xl p-6 hover:border-red-500/40 transition-all group">
            ...
            <p className="text-sm text-muted-foreground mb-3">40+ country emergency numbers</p>
