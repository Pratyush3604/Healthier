...
3. **Possible Causes** - List the most likely conditions
4. **Recommended Actions** - What the user should do now
5. **When to Seek Care** - Red flags to watch for
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            {selectedSymptoms.length > 0 && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <Button variant="ghost" size="sm" onClick={() => setSelectedSymptoms([])} className="text-muted-foreground">
                  Clear all
                </Button>
              </div>
            )}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {symptoms.map((symptom) => (
                      <button
                        ...
                        className={cn("symptom-chip", selectedSymptoms.includes(symptom) && "selected")}
                      >
                        {symptom}
                      </button>
                    ))}
            ...
            <div className="flex gap-3">
              ...
              {ai.response && (
                <Button variant="outline" onClick={handleReset} size="lg">Start Over</Button>
              )}
            </div>
          </div>
          ...
          <AIResponseCard
            ...
            emptyDescription='Choose symptoms from the list and click "Get Assessment" to receive an AI-powered preliminary evaluation.'
          />
        </div>
      </div>
    </div>
