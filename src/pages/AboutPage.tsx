      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-2 text-muted-foreground mb-4">
                <School className="h-4 w-4" /><span>Mayo College, Ajmer</span>
              </div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Mediredy</strong> originally started as an idea for WRO (World Robot Olympiad), but over time it evolved into a full-fledged AI-powered medical system.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="icon-container w-12 h-12"><Sparkles className="h-6 w-6" /></div>
            <h2 className="font-display text-xl font-bold">What Mediredy Can Do</h2>
          </div>
          <div className="flex flex-wrap gap-3">
            {capabilities.map((cap, index) => (
              <motion.span key={index} initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3 + index * 0.05 }}
                ...
                <span className="text-lg">✓</span>{cap}
              </motion.span>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
          ...
          <div className="text-center">
            <div className="icon-container-accent w-14 h-14 mx-auto mb-4"><Heart className="h-7 w-7" /></div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="text-center mt-12 text-muted-foreground">
          <p className="flex items-center justify-center gap-2"><Award className="h-5 w-5 text-primary" />Built with passion for WRO and beyond</p>
        </motion.div>
      </motion.div>
    </div>
  );
