...
const pageConfigs: Record<string, any> = {
  ...
  symptoms: {
    particles: {
      ...
      number: { value: 210, density: { enable: true } },
  ...
  fitness: {
    particles: {
      ...
      number: { value: 225, density: { enable: true } },
      size: { value: { min: 2, max: 6 } },
  ...
  medicine: {
    particles: {
      ...
      number: { value: 165, density: { enable: true } },
  ...
  reports: {
    particles: {
      ...
      shape: { type: 'polygon', options: { polygon: { sides: 4 } } },
      number: { value: 135, density: { enable: true } },
  ...
  settings: {
    particles: {
      ...
      number: { value: 105, density: { enable: true } },
      size: { value: { min: 2, max: 5 } },
      opacity: { value: { min: 0.08, max: 0.25 } },
